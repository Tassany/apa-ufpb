...
void ILS::run(std::vector<std::vector<Vizinhanca::Produto>> &melhorSolucao, int numIteracoes, std::vector<int> &Melhorlinhas, std::vector<std::vector<Vizinhanca::Produto>> &solucao, std::vector<int> &linhas, int numLinhasProducao, int *matrizProd, int numProdutos)
{
    Util utils;
