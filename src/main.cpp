...
int main()
{
    ...
    std::ifstream inputFile("./instancias/n15m4_A.txt"); // Nome do arquivo de entrada
    ...
    // std::cout << "Apenas guloso - Solucao final: " << HorasGastas << std::endl;
    // Apenas o Guloso - Fim -------------------------------------------------
    ...
    std::cout << "VND - Solucao final: " << HorasGastas << std::endl;
    ...
    // ils.run(melhorSolucao, numIteracoes, Melhorlinhas, solucao, linhas, numLinhasProducao, matrizProd, numProdutos);
    ...
    // HorasGastas = Melhorlinhas[utils.indiceMaiorValor(Melhorlinhas, numLinhasProducao)];
    // std::cout << "ILS - Solucao final: " << HorasGastas << std::endl;
